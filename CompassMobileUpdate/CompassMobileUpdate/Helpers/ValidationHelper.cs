...
namespace CompassMobileUpdate.Helpers
{
    public static class ValidationHelper
    {
        ...
        private static void HideValidationFields(object model, Page page, string validationLabelSuffix = "Error")
        {
            ...
            var properties = GetValidationPropertyNames(model);
        ...
        private static IEnumerable<string> GetValidationPropertyNames(object model)
        {
            var validatableProperties = new List<string>();
            var properties = GetValidationProperties(model);
        ...
        private static List<PropertyInfo> GetValidationProperties(object model)
        {
